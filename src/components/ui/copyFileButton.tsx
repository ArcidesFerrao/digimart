// components/CopyFileLinkButton.tsx
"use client";

import { Button } from "@/components/ui/button";
import { toast } from "sonner";

export function CopyFileLinkButton({ fileUrl }: { fileUrl: string | null }) {
  function handleCopy() {
    if (!fileUrl) {
      toast.error("Este produto ainda não tem ficheiro associado.");
      return;
    }
    navigator.clipboard.writeText(fileUrl);
    toast.success("Link do ficheiro copiado!");
  }
